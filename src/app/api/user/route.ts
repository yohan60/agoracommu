...
// // Définir un schema pour les validations d'input
...
//     // Regarder si l'email existe
//     const existingUserByEmail = await db.user.findUnique({
//       where: { email: email },
//     });
//     if (existingUserByEmail) {
//       return NextResponse.json(
//         { user: null, message: "Adresse email déjà utilisé" },
//         { status: 409 }
//       );
//     }

//     // Regarder si le nom utilisateur existe
...
//     return NextResponse.json(
//       { user: rest, message: "Utilisateur crée" },
//       { status: 201 }
//     );
//   } catch (error) {
//     return NextResponse.json(
